---
title: "Calculations and charts - Insular italian provinces (by region) - COVID-19 Epidemic"
...
islands_key<-provinces_regions_zones_key[provinces_regions_zones_key$zone_name=="Islands",]
province_names_islands<-select(islands_key,province_name)
region_names_islands<-arrange(distinct(select(islands_key,denominazione_regione)),denominazione_regione)
```

```{r echo=FALSE, message=FALSE}
provinces_data<-inner_join(provinces_data, province_names_islands, by=c('denominazione_provincia'='province_name'))
