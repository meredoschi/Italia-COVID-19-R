---
title: "Calculations and charts - Central italian provinces (by region) - COVID-19 Epidemic"
...
center_key<-provinces_regions_zones_key[provinces_regions_zones_key$zone_name=="Center",]
province_names_center<-select(center_key,province_name)
region_names_center<-arrange(distinct(select(center_key,denominazione_regione)),denominazione_regione)
```

```{r echo=FALSE, message=FALSE}
provinces_data<-inner_join(provinces_data, province_names_center, by=c('denominazione_provincia'='province_name'))
