---
title: "Calculations and charts - Southern italian provinces (by region) - COVID-19 Epidemic"
...
south_key<-provinces_regions_zones_key[provinces_regions_zones_key$zone_name=="South",]
province_names_south<-select(south_key,province_name)
region_names_south<-arrange(distinct(select(south_key,denominazione_regione)),denominazione_regione)

```

```{r echo=FALSE, message=FALSE}
provinces_data<-inner_join(provinces_data, province_names_south, by=c('denominazione_provincia'='province_name'))
